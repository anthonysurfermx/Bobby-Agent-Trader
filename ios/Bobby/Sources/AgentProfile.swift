...
enum AgentVoice: String, CaseIterable, Identifiable {
    ...
    var flavor: String {
        ...
        case .ballad: return L.t("chill · smooth", "relajada · suave")
...
enum AuraForge {
    ...
    static func archetype(hue: Double) -> (name: String, motto: String) {
        switch hue {
        case ..<0.06, 0.95...: return (L.t("CONTRARIAN", "CONTRACORRIENTE"), L.t("goes against the herd", "va contra la manada"))
        case ..<0.10: return (L.t("SCALPER", "RELÁMPAGO"), L.t("fast and unattached", "rápido y sin apego"))
        case ..<0.30: return (L.t("SWING", "VAIVÉN"), L.t("golden patience", "paciencia dorada"))
        case ..<0.47: return (L.t("TREND RIDER", "SURFISTA"), L.t("surfs the trend", "surfea la tendencia"))
        case ..<0.56: return (L.t("SNIPER", "FRANCOTIRADOR"), L.t("waits for the exact level", "espera el nivel exacto"))
        case ..<0.68: return (L.t("SYSTEMATIC", "SISTEMÁTICO"), L.t("data over vibes", "datos sobre corazonadas"))
        case ..<0.82: return (L.t("NIGHT OWL", "BÚHO NOCTURNO"), L.t("lives the night session", "vive la sesión nocturna"))
        default: return (L.t("SENTIMENT", "SENTIMIENTO"), L.t("reads the market mood", "lee el ánimo del mercado"))
        }
    }
}
