...
| BP-10 | migration `0012`, `api/agents/register.ts`, `api/agents/transfer.ts` | Register with a stale version; change owner through registration; replay a transfer request id. |
