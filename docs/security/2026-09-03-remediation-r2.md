...
**Verification record (2026-09-05).** Foundry: DeploymentGates 34/34 and the full suite (see the
commit message for the count); `check-sizes.sh` 7/7 within EIP-170; `check-layout.sh` OK.
