// ============================================================
// POST /api/generate-activity — RETIRED (2026-09-03)
...
export default async function handler(_req: VercelRequest, res: VercelResponse) {
  ...
  return res.status(410).json({
    ...
    error: 'generate-activity is retired: X Layer is archive-only and Bobby signs no synthetic protocol activity',
  });
}
